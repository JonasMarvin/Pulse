...
namespace Pulse::Modules {
	...
	public:
		...
		void Submit(const Ref<Rendering::Shader> shader, const Ref<Rendering::VertexArray>& vertexArray, const glm::mat4& transform = glm::mat4(1.0f)); // function to submit a object to get rendered
